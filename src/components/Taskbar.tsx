...
export default function Taskbar({ windows, onToggleMinimize, onTaskbarContextMenu, onStartButtonContextMenu, startButtonContextMenuOpen, onOpenWindow }: TaskbarProps) {
